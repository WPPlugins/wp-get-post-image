...
Plugin URI: http://michaelwender.com/
...
Author URI: http://michaelwender.com/tools/wp-get-post-image
...
function wp_get_post_image($args){
	...
	if($image){
		...
		$image->basepath = ABSPATH.str_replace(get_bloginfo('url').'/','',$image->guid);
